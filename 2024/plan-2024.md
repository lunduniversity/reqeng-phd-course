...
The table below shows the seminar plan.

You are expected to read the literature references in the tables "Read" column. Most acronyms in the "Read" column are specified here: https://cs.lth.se/krav/literature/ Extra acronyms are defined in the bullet-list after the table.

The Read column is just tentative - we can add/remove stuff as we go along. But the Read row items before the next-up seminar is stable two weeks before the seminar so that you can start reading in good time before each seminar. 
...
|4|2024-05-08|13:15-17|Special Domains and Contexts: Agile RE, Open-Source RE, Regulatory Requirements, High-Assurance Systems| AGRE, OSSRE, RE4AI, EU-AI-ACT, EU-GDPR, SMIRK, HAS |
...
* RE4AI: Each participant selects one paper that you want to read that no other participant reads and get ok on the paper from Bjorn via email. You present your paper on Seminar 4. Prepare 5-10 min summary and you lead the following discussion for 10 min. Starting-point for your search of an interesting paper: [Sadovski, Aviv, Hadar. "Towards a Comprehensive Ontology for Requirements Engineering for AI-powered Systems" Refsq 2024.](https://coursegit.cs.lth.se/bjorn.regnell/reqeng-phd-course-project/-/tree/main/papers?ref_type=heads)

* Papers on regulatory requirements to discuss at Seminar 4:
  ...
  * Exemplar on high-assurance systems with AI to discuss at Seminar 4:
    * SMIRK: https://github.com/RI-SE/smirk/tree/main/docs

  * HAS: ~~To be decided.~~ I decided to not include any specific paper on high-assurance RE to not make the pile of papers to big. But there are many available if you want to dig deeper; [see this scholar.google.com search on "high-assurance requirements engineering"](https://scholar.google.com/scholar?hl=sv&as_sdt=0%2C5&q=high-assurance+requirements+engineering&btnG=)- Also, there was [this special issue in IEEE Computer in April 1998](https://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=14652&punumber=2) on HAS with [this short intro](https://ieeexplore.ieee.org/document/666840) defining what HAS means
...
## *Notes from:* Planning meeting was held 2024-02-36

These notes are kept here as inspiration for coming instances of this course. The below notes are superseded by the actual plan above.

TODO before the planning meeting:
* prepare the meeting by talking to your supervisor about the proposal below.

### Proposed course parts:
